...
def involved(courses, person):
    ...
    for hexamester in courses:
        for course in courses[hexamester]:
            for properties in courses[hexamester][course]:
                if courses[hexamester][course][properties] == person:
                    if hexamester in hexamester_dic:
                        hexamester_dic[hexamester].append(course)
                    else:
                        hexamester_dic[hexamester] = [course]
    return hexamester_dic
